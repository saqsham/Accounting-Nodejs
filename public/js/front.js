$(function () {
    ...
    function adjustFooter() {
        const footerBlockHeight = $('.footer__block').outerHeight();
    ...
    if ($('#style-switch').length > 0) {
        const stylesheet = $('link#theme-stylesheet');
        $("<link id='new-stylesheet' rel='stylesheet'>").insertAfter(stylesheet);
        const alternateColour = $('link#new-stylesheet');
        ...
        $("#colour").change(function () {
            ...
            if ($(this).val() !== '') {
                ...
                const theme_csspath = 'css/style.' + $(this).val() + '.css';
