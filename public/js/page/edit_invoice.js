...
total_modals = $('#my_company').attr('items_quantity');
...
$(document).on('click','.button_serial_no',function(){
    ...
    var quantity_id= $('#quantity_'+last_char+'');
    var total_quantity=parseInt(quantity_id.attr(''+modal_name+'_total_quantity'));
    var serial_mymodal1 = total_quantity;
    serial_mymodal1++;
...
function gst_update(){
    ...
    $('#sgst').val(sgst);
    $('#igst').val(igst);
    console.log(total_price.toFixed(2),total_price.toFixed(0));
